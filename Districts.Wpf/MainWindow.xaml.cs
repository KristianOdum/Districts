...
public partial class MainWindow : Window
{
    ...
    private async void EditPrimarySalesperson_Click(
        ...
        RoutedEventArgs e)
    {
        if (_viewModel.SelectedDistrictDetails is null) return;

        var dialog = new SalespersonDialog(
            _viewModel.Salespersons,
            [_viewModel.SelectedDistrictDetails.PrimarySalesperson.Id],
        ...
        RoutedEventArgs e)
    {
        ...
        var dialog = new SalespersonDialog(
            _viewModel.Salespersons, excludedIds, SalespersonRole.Secondary)
        {
            Owner = this
        };
        ...
        RoutedEventArgs e)
    {
        ...
        if (_viewModel.SelectedDistrict is null) return;
